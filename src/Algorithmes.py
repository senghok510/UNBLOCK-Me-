...
def BFS_search_with_nb_blocking_heuristic(initial_state, print_solution=True, max_iterations=100000):
    """
    A* Search (BFS with heuristic) using a blocking-based heuristic.
